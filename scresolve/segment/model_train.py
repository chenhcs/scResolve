from src import transformer #, postprocessing
...
transformer.train(dataset, startr, startc, patch_size, epochs)
#postprocessing.postprocess(startr, startc, patch_size, 5, 15, 500)
