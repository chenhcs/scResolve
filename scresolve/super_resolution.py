...
from .logging import INFO, log, LOGGER
...
from .session.io import save_session, load_session
from .segment.super_resolution_to_segment import super_resolution_to_segment_converter
...
def super_resolution(
    ...
    expansion_strategy: ExpansionStrategy = STRATEGIES[
        CONFIG["super_resolution_expansion_strategy"].value["type"].value
    ](),
    purge_interval: int = (
        CONFIG["super_resolution_expansion_strategy"].value["purge_interval"].value
    ),
    network_depth: int = CONFIG["super_resolution_model"].value["network_depth"].value,
    network_width: int = CONFIG["super_resolution_model"].value["network_width"].value,
    min_counts: int = CONFIG["super_resolution_model"].value["min_counts"].value,
    gene_regex: str = CONFIG["super_resolution_model"].value["min_counts"].value,
    patch_size: int = CONFIG["super_resolution_optimization"].value["patch_size"].value,
    batch_size: int = CONFIG["super_resolution_optimization"].value["batch_size"].value,
    epochs: int = CONFIG["super_resolution_optimization"].value["epochs"].value,
    learning_rate: float = CONFIG["super_resolution_optimization"].value["learning_rate"].value,
