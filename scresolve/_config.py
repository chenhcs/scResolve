                    ...
                    [
                        (
                            ...
                            Item(
                                ...
                                comment=" ".join(
                                    [
                                        "If true, Check the number of metagenes in the saved sessions, write tensors",
                                        "If false, last session is used",
                                    ]
                                ),
                            ),
                        ),
                        (
                            ...
                            Item(
                                ...
                                comment=" ".join(
                                    [
                                        "Minimum number of metagenes",
                                        "Used only if backtrack is True",
                                    ]
                                ),
                            ),
                        ),
                    ...
                    [
                       ...
                       (
                           ...
                           Item(
                               ...
                               comment=" ".join(
                                   [
                                       "Segment model requires a grey scaled image as a part of the input",
                                       "Set False if you already converted your image to the grey scaled image"
                                   ]
                               ),
                           ),
                       ),                        
